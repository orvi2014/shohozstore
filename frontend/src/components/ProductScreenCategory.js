        ...
        <section className="text-gray-600 body-font">
                <div className="container px-2 pt-1 pb-10 mx-auto">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-90">
                            <Link to='#'  className='no-underline'><h2  className={"text-lg sm:text-xl disabled" +(props.category == '' ? 'text-gray': ' text-gray-500')+" font-medium title-font mb-2 text-center hover:text-gray"}>Category #7</h2></Link>
                        </div>
                        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-90">
