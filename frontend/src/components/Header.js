      ...
      sections: [
        {
          ...
          name: 'Clothing',
          items: [
            { name: 'Tops', href: '/search/Top' },
            { name: 'Blazers', href: '/search/Blazer' },
            { name: 'Pants', href: '/search/Pant' },
            { name: 'Denim', href: '/search/Denim' },
            { name: 'Sweaters', href: '/search/Sweater' },
            { name: 'T-Shirts', href: '/search/t-shirt' },
            { name: 'Jackets', href: '/search/Jacket' },
      ...
      sections: [
        {
          ...
          name: 'Electronics',
          items: [
            { name: 'Smart Phones', href: '/search/phone' },
            { name: 'Watches', href: '#' },
        ...
        
        {
          ...
          name: 'Laptop',
          items: [
            { name: 'Work', href: '/search/work' },
            { name: 'Student', href: '/search/student' },
            { name: 'Gaming', href: '/search/gaming' },
            { name: '-', href: '#' },
            { name: '-', href: '#' },
            { name: '-', href: '#' },
          ],
