      ...
      sections: [
        {
          ...
          items: [
            ...
            { name: 'Browse All', href: '/products/header/Electronics' },
          ],
        },
        ...
        },
        {
          ...
          name: 'Brands',
          items: [
            { name: 'Apple', href: '/products/header/Electronics-Apple' },
            { name: 'Samsung', href: '/products/header/Electronics-Samsung' },
            { name: 'Asus', href: '/products/header/Electronics-Asus' },
            { name: 'Canon', href: '/products/header/Electronics-Canon' },
            { name: 'HP', href: '/products/header/Electronics-HP' },
          ],
        },
      ],
    },
