    ...
    return (
        ...
        <form onSubmit={submitHandler} inline>
            ...
            <div class="flex border-2 rounded">
                <input type="text" class="px-4 py-2 w-80 lg:block hidden" placeholder="Search Products ..." name="q" value={keyword} onChange={(e)=>setKeyword(e.target.value)} />
                <button type="submit" class="flex items-center justify-center px-4  lg:block hidden text-white">
